...
window.ListBookingController = function($scope,$http,$location){
    ...
    $scope.onSubmit = function(){
            ...
            if(!$scope.booking || !$scope.booking.payments){
                    flag = false;
                    $scope.kiemtra.payments = true;    
                    $scope.errorMessages.payments = 'Vui lòng chọn hình thức thanh toán';
            }
            ...
            if(flag){
                    ...
                    $scope.FullName = newItem.FullName;
                    $scope.Phone = newItem.Phone;
                    $scope.Card = newItem.Card;
                    $scope.Email = newItem.Email;
                    $scope.Gender = newItem.Gender;
                    $scope.Flight = newItem.Flight;
                    $scope.Birthday = newItem.Birthday;
                    $scope.Luggage = newItem.FullLuggageName;
